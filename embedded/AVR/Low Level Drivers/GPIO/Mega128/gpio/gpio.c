...
volatile const gpio_RegisterAddresstype gpio_RegisterAdress_as[MAX_NUM_OF_PORTS] =
{
      ...
      {
            (uint8*) GPIO_PORTE_ADDRESS,
            (uint8*) GPIO_DDRE_ADDRESS,
            (uint8*) GPIO_PINE_ADDRESS
      },
      {
            (uint8*) GPIO_PORTF_ADDRESS,
            (uint8*) GPIO_DDRF_ADDRESS,
            (uint8*) GPIO_PINF_ADDRESS
      },
      {
            (uint8*) GPIO_PORTG_ADDRESS,
            (uint8*) GPIO_DDRG_ADDRESS,
            (uint8*) GPIO_PING_ADDRESS
      }
};

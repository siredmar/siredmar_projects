...
typedef enum
{
   ...
   DIO_CHANNEL_PE0 = 0x0400,
   DIO_CHANNEL_PE1 = 0x0401,
   DIO_CHANNEL_PE2 = 0x0402,
   DIO_CHANNEL_PE3 = 0x0403,
   DIO_CHANNEL_PE4 = 0x0404,
   DIO_CHANNEL_PE5 = 0x0405,
   DIO_CHANNEL_PE6 = 0x0406,
   DIO_CHANNEL_PE7 = 0x0407,

   DIO_CHANNEL_PF0 = 0x0500,
   DIO_CHANNEL_PF1 = 0x0501,
   DIO_CHANNEL_PF2 = 0x0502,
   DIO_CHANNEL_PF3 = 0x0503,
   DIO_CHANNEL_PF4 = 0x0504,
   DIO_CHANNEL_PF5 = 0x0505,
   DIO_CHANNEL_PF6 = 0x0506,
   DIO_CHANNEL_PF7 = 0x0507,

   DIO_CHANNEL_PG0 = 0x0600,
   DIO_CHANNEL_PG1 = 0x0601,
   DIO_CHANNEL_PG2 = 0x0602,
   DIO_CHANNEL_PG3 = 0x0603,
   DIO_CHANNEL_PG4 = 0x0604,
   DIO_CHANNEL_PG5 = 0x0605,
   DIO_CHANNEL_PG6 = 0x0606,
   DIO_CHANNEL_PG7 = 0x0607
}dio_channelType;
